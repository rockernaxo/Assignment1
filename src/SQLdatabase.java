...
public class SQLdatabase {
	...
	private static final String PASS = "root"; // insert the password to SQL
												// server
	...
	public SQLdatabase(ArrayList<CircuitBreaker> breakerList, ArrayList<BaseVoltage> bVoltList,
			ArrayList<Substation> subList, ArrayList<VoltageLevel> voltLvlList, ArrayList<SynchronousMachine> synMach,
			ArrayList<GeneratingUnit> genUnit, ArrayList<RegulatingControl> regControl,
			ArrayList<PowerTransformer> powtrafo, ArrayList<PowerTransformerEnd> powtrafoEnd,
	...
	public void create() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Have you initiated the SQL server? Can't connect...");
